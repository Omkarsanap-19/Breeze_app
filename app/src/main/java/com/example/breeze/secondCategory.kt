...
import com.example.breeze.databinding.FragmentSecondCategoryBinding
...
class secondCategory : Fragment() {
    ...
    private fun fetchNews() {
        ...
        val news = RetrofitInstance.newsInstance.getHeadlines(UniversalVariable.sharedValue, "in", "World",currentPage)
