...
import com.example.breeze.databinding.FragmentSeventhCategoryBinding
...
class seventhCategory : Fragment() {
    private var _binding: FragmentSeventhCategoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSeventhCategoryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun fetchNews() {
        ...
        val news = RetrofitInstance.newsInstance.getHeadlines(UniversalVariable.sharedValue, "in", "Entertainment",currentPage)
