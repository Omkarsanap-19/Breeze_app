...
import com.example.breeze.databinding.FragmentThirdCategoryBinding
...
class thirdCategory : Fragment() {
    private var _binding: FragmentThirdCategoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentThirdCategoryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun fetchNews() {
        ...
        val news = RetrofitInstance.newsInstance.getHeadlines(UniversalVariable.sharedValue, "in", "Sports" , currentPage)
